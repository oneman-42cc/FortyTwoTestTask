...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entry.change_message'
        db.delete_column(u'hello_entry', 'change_message')


    def backwards(self, orm):
        # Adding field 'Entry.change_message'
        db.add_column(u'hello_entry', 'change_message',
