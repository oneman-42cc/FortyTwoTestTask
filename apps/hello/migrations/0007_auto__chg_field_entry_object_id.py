...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.object_id'
        db.alter_column(u'hello_entry', 'object_id', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Entry.object_id'
        db.alter_column(u'hello_entry', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'hello.entry': {
            ...
            'event': ('django.db.models.fields.CharField', [], {'default': "'creation'", 'max_length': '256'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
        'hello.profile': {
